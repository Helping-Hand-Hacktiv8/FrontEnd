...
export default function ChatScreen(props) {
      ...
      async function getData() {
        try {
          ...
          setUser({
            ...
            photoUrl: "https://helping-hand-server.blekzzz.com" + "/static/" + dataUser.profileImg,
          });
        } catch (error) {
          console.log(error);
        }
  ...
  if (from == "ChatList") {
        ...
        async function getData() {
          try {
            ...
            setAuthor({
              ...
              photoUrl: "https://helping-hand-server.blekzzz.com" + "/static/" + dataAuthor.profileImg,
            });
          } catch (error) {
            console.log(error);
          }
    ...
    conversationBuilder = TalkRn.getConversationBuilder(TalkRn.oneOnOneId(user, author));
